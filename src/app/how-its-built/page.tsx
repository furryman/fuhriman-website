      ...
      <section className={styles.section}>
        ...
        <ScrollReveal>
          ...
          <p className={styles.architectureNote}>
            ...
            nodes needed, reducing costs from ~$80/mo to ~$22/mo while maintaining GitOps best
            practices.
          </p>
        </ScrollReveal>
      </section>
          ...
          <div className={styles.highlights}>
            <div className={styles.highlight}>
              ...
              <p>
                ...
                zone. No NAT Gateway needed since everything runs in the public subnet,
            ...
            <div className={styles.highlight}>
              ...
              <p>
                Installs iptables rules that jump pod CIDR traffic destined for the public IP
                directly into kube-proxy&apos;s KUBE-EXT chains. This solves the AWS hairpin NAT
                problem for cert-manager HTTP-01 validation at the network layer.
              </p>
            </div>
          </div>
        </ScrollReveal>
          ...
          <div className={styles.gitopsFlow}>
            <div className={styles.flowStep}>
              ...
              <div className={styles.stepContent}>
                ...
                <p>
                  A parent Application manages child Applications, enabling hierarchical deployment
                  of the entire stack.
                </p>
              </div>
            </div>
            <div className={styles.flowStep}>
              ...
              <div className={styles.stepContent}>
                <h4>Sync Waves</h4>
                <p>
                  Applications deploy in order: cert-manager (-2) → ingress-nginx (-1) → website
                  (0), ensuring dependencies are ready.
                </p>
              </div>
            </div>
            <div className={styles.flowStep}>
  ...
  build-and-deploy:
    ...
    steps:
      ...
      <section className={styles.section}>
        ...
        <ScrollReveal>
          <p className={styles.sectionIntro}>
            One of the interesting technical challenges was getting Let&apos;s Encrypt certificates
            to work on a single-node cluster behind a public IP.
          </p>
        </ScrollReveal>
        <ScrollReveal stagger>
          <div className={styles.highlights}>
            <div className={styles.highlight}>
              ...
              <p>
                ...
                won&apos;t loop packets back to the same host — so these connections fail even
                though external validation works fine.
              </p>
            </div>
            <div className={styles.highlight}>
              ...
              <p>
                ...
                KUBE-EXT chain names and adds rules that jump pod CIDR (10.42.0.0/16) traffic
                destined for the public IP directly into those chains — piggy-backing on
                kube-proxy&apos;s existing DNAT-to-pod routing with no application-level
                workarounds.
              </p>
            </div>
            <div className={styles.highlight}>
              ...
              <p>
                ...
                entirely. By jumping into kube-proxy&apos;s own chains instead, the packet follows
                the same path as external traffic.
              </p>
            </div>
          </div>
        </ScrollReveal>
