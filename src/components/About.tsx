      ...
      <div className="container">
        <ScrollReveal>
          ...
          <div className={styles.content}>
            ...
            <p>
              That conviction drove me to DevOps. At ACD Direct, I led a company-wide transformation
              during a period of rapid growth, replacing entirely manual deployments with automated
              pipelines. At MasterControl, I scaled that mindset to a large Kubernetes platform on
              AWS, implementing GitOps workflows and codifying infrastructure with Terraform. Every
              improvement was rooted in the same idea: automate the toil so teams can focus on work
            ...
            <p>
              ...
              the same practical mindset: adopt what genuinely augments the team&apos;s capability,
              and skip the hype that doesn&apos;t.
            </p>
          </div>
        </ScrollReveal>
      </div>
